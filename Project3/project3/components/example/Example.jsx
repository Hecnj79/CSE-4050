...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      motto: window.cse4050models.exampleModel().motto,
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
    };
    ...
    this.handleMottoBound = event => this.handleMottoChange(event);
  ...
  render() {
    return (
      <div className="container Example">
        <h1>CSE4050 Project#3 React.js Example</h1>
        ...
        <div className="motto-update">
          ...
          <input id="inId" type="text" value={this.state.motto} onChange={this.handleMottoBound} />
        </div>
